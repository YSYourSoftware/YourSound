...
YS_CORE_EXPORT inline void ysbp_player_render(YS_PlayerHandle player, float *output_buffer,
...
YS_CORE_EXPORT inline void ysbp_player_render_graphics(YS_PlayerHandle player) {
	static_cast<YourSound::Player *>(player)->render_graphics();
}

YS_CORE_EXPORT inline void ysbp_player_reset(YS_PlayerHandle player) {
	static_cast<YourSound::Player *>(player)->reset();
}

YS_CORE_EXPORT inline const char *ysbp_player_get_id(YS_PlayerHandle player) {
	return static_cast<YourSound::Player *>(player)->get_id();
}

YS_CORE_EXPORT inline void ysbp_destroy_bin_player(YS_PlayerHandle player) {
...
YS_CORE_EXPORT inline const char *ysbp_get_library_location() {
